...
export default function Footer() {
  return (
    <footer style={{ position: 'relative', background: '#08070c', padding: 'clamp(48px,7vh,80px) clamp(20px,6vw,88px) clamp(26px,4vh,36px)' }}>
      ...
      >
        <img src="/images/logo-m4rquez.png" alt="DJ M4rquez" loading="lazy" style={{ width: 'clamp(120px,12vw,160px)', height: 'auto', display: 'block' }} />
      ...
      <div style={{ maxWidth: 1320, margin: 'clamp(28px,4vh,44px) auto 0', paddingTop: 22, borderTop: '1px solid rgba(245,240,232,0.08)' }}>
        <p style={{ margin: 0, fontSize: 12, color: 'rgba(245,240,232,0.35)', letterSpacing: '0.02em' }}>
          © 2026 DJ M4rquez. Todos os direitos reservados.
        </p>
      </div>
    </footer>
  );
